    ...
    return car && (
        <div  onClick={() => props.onSelect && props.onSelect(car)}
            ...
            rounded-xl cursor-pointer text-[#fff] p-5'>
                ...
                <p className="absolute top-0 right-2 flex items-center gap-1 my-3 p-2 rounded-md font-bold text-[10px] bg-blue-600"><GiSteeringWheel className="text-[20px]"/>
                ...
                <p className="text-[12px] flex items-center gap-1">
                           <GrCheckmark className="text-[12px] text-green-500" /> Kilométrage inclus {car?.kilometrageInclus}  km</p>
